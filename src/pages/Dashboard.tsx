...
const Dashboard = () => {
  const { lessons, tracks, isLoading } = useLessons();
    ...
    return (
      <div className="container mx-auto p-8">
        <div className="text-center py-12">
          <p className="text-muted-foreground">Загрузка уроков...</p>
        </div>
      </div>
    );
  }
  ...
  if (!selectedTrack) {
    return (
      <div className="container mx-auto p-8">
        <div className="text-center py-12">
          <p className="text-muted-foreground">Нет доступных направлений обучения</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="container mx-auto p-8">
      <div className="mb-8">
        <h1 className="text-4xl font-bold mb-2">Добро пожаловать на Pro English!</h1>
